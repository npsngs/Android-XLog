...
public class XlogActivity extends Activity implements View.OnClickListener{
    View v;
    XlogActivity activity;
    @Override
        ...
        switch (v.getId()){
            ...
            case R.id.btn_sendLog:
                XLog.i("test",".view.ViewPager.setCurrentItem(ViewPager.java:562)\n" +
                        ...
                        "11-03 18:27:43.042 14150-14150/com.yxd.live W/https://www.baidu.com,\n System.err:     at android.os.Looper.loop(Looper.java:148)\n" +
            ...
            case R.id.btn_start_activity:
                startActivity(new Intent(this, XlogActivity.class));
                break;
        }
    }
